...
<Grid item xs={12} sm={6} md={6}  >
	<div className="page2_text">
				...
				>
					...
					omnis repellendus mollitia, explicabo, maiores quisquam numquam quia
					reiciendis sit, accusantium atque ex animi perspiciatis ab odit earum
					assumenda aliquid.
				</Typography>
				<Typography
					sx={{
...
<div className="counter">
				<Typography
					...
					className="count"
				>
					0<span style={{ fontSize: '30px', color: '#ff60ce' }}>3</span>
				</Typography>
				<Typography
					variant="subtitle2"
					sx={{
